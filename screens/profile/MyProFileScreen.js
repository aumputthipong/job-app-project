      ...
      {userData ? (
         ...
         <View style={{ ...styles.profileBox, ...{ backgroundColor: "white" } }}>
           <View style={{ ...styles.postRow, ...styles.postHeader, ...{} }}>
             ...
             <FontAwesome5 name={'edit'} size={22} onPress={startEditing} style={{...{ paddingLeft: 50, paddingTop: 10} }}/>
           ...
           <Ionicons name={'log-out-outline'} size={30} onPress={handleLogout} style={{...{ color: "red", left: 310, top: 70} }}/>
         </View>
         {/*2 ContactBox */}
